...
CREATE TABLE `t_sys_area`  (
  ...
  `areaCode` varchar(40) NOT NULL COMMENT '区代码',
  `cityCode` varchar(40) NULL DEFAULT NULL COMMENT '父级市代码',
  `areaName` varchar(40) NOT NULL COMMENT '市名称',
  `shortName` varchar(20) NOT NULL COMMENT '简称',
  `lng` varchar(20) NULL DEFAULT NULL COMMENT '经度',
  `lat` varchar(20) NULL DEFAULT NULL COMMENT '纬度',
  ...
  `memo` varchar(250) NULL DEFAULT NULL COMMENT '备注',
  `dataState` int(11) NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `Index_1`(`areaCode`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2013 COMMENT = '地区设置';
...
CREATE TABLE `t_sys_city`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增列',
  `cityCode` varchar(40) NOT NULL COMMENT '市代码',
  `cityName` varchar(40) NOT NULL COMMENT '市名称',
  `shortName` varchar(20) NOT NULL COMMENT '简称',
  `provinceCode` varchar(40) NULL DEFAULT NULL COMMENT '省代码',
  `lng` varchar(20) NULL DEFAULT NULL COMMENT '经度',
  `lat` varchar(20) NULL DEFAULT NULL COMMENT '纬度',
  `sort` int(6) NULL DEFAULT NULL COMMENT '排序',
  `gmtCreate` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
) ENGINE = InnoDB AUTO_INCREMENT = 256 COMMENT = '城市设置';
...
CREATE TABLE `t_sys_department`  (
  ...
  `parentId` varchar(255) NULL DEFAULT NULL COMMENT '父id',
  `deptName` varchar(255) NULL DEFAULT NULL COMMENT '部门名称',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 COMMENT = '部门表';
...
CREATE TABLE `t_sys_dict_data`  (
  ...
  `dictLabel` varchar(100) NULL DEFAULT '' COMMENT '字典标签',
  `dictValue` varchar(100) NULL DEFAULT '' COMMENT '字典键值',
  `dictType` varchar(100) NULL DEFAULT '' COMMENT '字典类型',
  `cssClass` varchar(100) NULL DEFAULT '' COMMENT '样式属性（其他样式扩展）',
  `listClass` varchar(100) NULL DEFAULT '' COMMENT '表格回显样式',
  `isDefault` char(1) NULL DEFAULT 'N' COMMENT '是否默认（Y是 N否）',
  `status` char(1) NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
  `createBy` varchar(64) NULL DEFAULT '' COMMENT '创建者',
  `createTime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updateBy` varchar(64) NULL DEFAULT '' COMMENT '更新者',
...
CREATE TABLE `t_sys_dict_type`  (
  `id` varchar(255) NOT NULL COMMENT '主键',
  `dictName` varchar(100) NULL DEFAULT '' COMMENT '字典名称',
  `dictType` varchar(100) NULL DEFAULT '' COMMENT '字典类型',
  `status` char(1) NULL DEFAULT '0' COMMENT '状态（0正常 1停用）',
  `createBy` varchar(64) NULL DEFAULT '' COMMENT '创建者',
  `createTime` datetime NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `t_sys_email`  (
  ...
  `receiversEmail` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '接收人电子邮件',
  ...
  `sendUserId` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '发送人id',
  `sendUserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '发送人账号',
  `createTime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB COMMENT = '电子邮件';
...
CREATE TABLE `t_sys_file`  (
  ...
  `fileName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '文件名字',
  `bucketName` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '桶名',
  `fileSize` bigint(50) NULL DEFAULT NULL COMMENT '文件大小',
  `fileSuffix` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '后缀',
  `createUserId` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '创建人id',
  `createUserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '创建人名字',
  `createTime` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `updateUserId` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '修改人',
  `updateUserName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '修改人名字',
...
CREATE TABLE `t_sys_inter_url`  (
  `id` varchar(255) NOT NULL COMMENT '主键',
  `interName` varchar(255) NULL DEFAULT NULL COMMENT '拦截名称',
  `url` varchar(255) NULL DEFAULT NULL COMMENT '拦截url',
  `type` int(2) NULL DEFAULT NULL COMMENT '类型',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB COMMENT = '拦截url表';
...
CREATE TABLE `t_sys_notice`  (
  ...
  `createId` varchar(255) NULL DEFAULT NULL COMMENT '创建人id',
  `createUsername` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '创建人name',
  `createTime` datetime NULL DEFAULT NULL COMMENT '发信时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_sys_notice_user`  (
  `id` varchar(255) NOT NULL COMMENT '主键',
  `noticeId` varchar(255) NULL DEFAULT NULL COMMENT '公告id',
  `userId` varchar(255) NULL DEFAULT NULL COMMENT '用户id',
  `state` int(2) NULL DEFAULT NULL COMMENT '0未阅读 1 阅读',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB COMMENT = '公告_用户外键';
...
CREATE TABLE `t_sys_oper_log`  (
  ...
  `operName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '操作人',
  `operUrl` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'url',
  `operParam` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '参数',
  `errorMsg` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL,
...
CREATE TABLE `t_sys_permission`  (
  ...
  `descripion` varchar(255) NULL DEFAULT NULL COMMENT '权限描述',
  `url` varchar(255) NULL DEFAULT NULL COMMENT '授权链接',
  `isBlank` int(255) NULL DEFAULT 0 COMMENT '是否跳转 0 不跳转 1跳转',
  `pid` varchar(255) NULL DEFAULT NULL COMMENT '父节点id',
...
CREATE TABLE `t_sys_permission_role`  (
  ...
  `roleId` varchar(255) NULL DEFAULT NULL COMMENT '角色id',
  `permissionId` varchar(255) NULL DEFAULT NULL COMMENT '权限id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_sys_position`  (
  `id` varchar(255) NOT NULL COMMENT '主键',
  `postName` varchar(255) NULL DEFAULT NULL COMMENT '岗位名称',
  `orderNum` int(11) NULL DEFAULT NULL COMMENT '排序',
...
CREATE TABLE `t_sys_province`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增列',
  `provinceCode` varchar(40) NOT NULL COMMENT '省份代码',
...
) ENGINE = InnoDB AUTO_INCREMENT = 23 COMMENT = '省份表';
...
CREATE TABLE `t_sys_quartz_job`  (
  ...
  `jobName` varchar(255) NULL DEFAULT NULL COMMENT '任务名称',
  `jobGroup` varchar(255) NULL DEFAULT NULL COMMENT '任务组名',
  `invokeTarget` varchar(255) NULL DEFAULT NULL COMMENT '调用目标字符串',
  `cronExpression` varchar(255) NULL DEFAULT NULL COMMENT 'cron执行表达式',
  `misfirePolicy` varchar(255) NULL DEFAULT NULL COMMENT 'cron计划策略',
  `concurrent` varchar(255) NULL DEFAULT NULL COMMENT '是否并发执行（0允许 1禁止）',
...
CREATE TABLE `t_sys_quartz_job_log`  (
  ...
  `jobGroup` varchar(255) NULL DEFAULT NULL COMMENT '任务组名',
  `invokeTarget` varchar(255) NULL DEFAULT NULL COMMENT '调用目标字符串',
  `jobMessage` varchar(255) NULL DEFAULT NULL COMMENT '日志信息',
  `status` int(11) NULL DEFAULT NULL COMMENT '执行状态（0正常 1失败）',
  `exceptionInfo` varchar(255) NULL DEFAULT NULL COMMENT '异常信息',
...
CREATE TABLE `t_sys_role_user`  (
  `id` varchar(255) NOT NULL,
  `sysUserId` varchar(255) NULL DEFAULT NULL COMMENT '用户id',
  `sysRoleId` varchar(255) NULL DEFAULT NULL COMMENT '角色id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_sys_street`  (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自增列',
  `streetCode` varchar(40) NOT NULL COMMENT '街道代码',
  `areaCode` varchar(40) NULL DEFAULT NULL COMMENT '父级区代码',
  `streetName` varchar(50) NOT NULL COMMENT '街道名称',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 COMMENT = '街道设置';
...
CREATE TABLE `t_sys_user`  (
  ...
  `posId` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '岗位id',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `t_test`  (
  ...
  `t_cb_name` varchar(255) NULL DEFAULT NULL COMMENT '写个字符串',
  PRIMARY KEY (`id`) USING BTREE
