...
public class OssEndpoint {
    ...
    // 	PutObjectResult putObjectResult=template.putObject(bucketName, fileSuffixName, object.getInputStream(), object.getSize()
    // 	, object.getContentType());
    // 	if(putObjectResult!=null){
    // 		SysFile sysFile=new SysFile(uuid,  fileSuffixName,  bucketName, object.getSize(), object.getContentType(),ShiroUtils
    // 		.getUserId(), ShiroUtils.getLoginName(), new Date(),null, null, null);
    ...
    // public AjaxResult createObject(@PathVariable("id") String id,@RequestBody MultipartFile object, @PathVariable
    // ("bucketName") String bucketName) throws Exception {
    ...
    // 		String uuid=SnowflakeIdWorker.getUUID();
    // 		String fileSuffixName=uuid+suffixName;
    // 		PutObjectResult putObjectResult=template.putObject(bucketName, fileSuffixName, object.getInputStream(), object
    // 		.getSize(), object.getContentType());
    // 		if(putObjectResult!=null){
    ...
    // 	String uuid=SnowflakeIdWorker.getUUID();
    // 	String fileSuffixName=uuid+suffixName;
    // 	PutObjectResult putObjectResult=template.putObject(bucketName, fileSuffixName, file.getInputStream(), file.getSize(),
    // 	file.getContentType());
    // 	if(putObjectResult!=null){
